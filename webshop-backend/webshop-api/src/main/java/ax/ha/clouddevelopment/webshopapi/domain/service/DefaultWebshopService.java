...
public class DefaultWebshopService implements WebshopService {
    ...
    public DefaultWebshopService() {
        this.products = new ArrayList<>(Arrays.asList(Product.builder()
                        .id(UUID.randomUUID())
                        .name("AWS Costs")
                        .image(create("https://lumecloud.com/wp-content/uploads/2017/10/Lume_BraceYourselves-AWS-meme.jpg"))
                ...
                Product.builder()
                        .id(UUID.randomUUID())
                        .name("In the cloud")
                        .image(create("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTe7S--qdUwTA0j2JJB9fiaLEPv4Ei5XbNA3w&usqp=CAU"))
                ...
                Product.builder()
                        ...
                        .image(create("https://www.memecreator.org/static/images/memes/5250630.jpg"))
                        .price(25)
                        .build()));
    }
